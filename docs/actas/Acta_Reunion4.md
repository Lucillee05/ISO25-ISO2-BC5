...
Actualizacion del trabajo despues de la tutoria con el profesor.
Correccion de diferentes aspectos respecto al trabajo realizado.
Realizacion del driagrama de casos de uso.
Actualizacion del calendario del trabajo respecto a la planificacion del trabajo.
Actualizacion de los grupos funcionales anteriores.
Realizacion de nuevas isues.
Creacion de supuestos de proyecto.
Actualizacion del contenido de las tablas del excel.
Correccion de las horas en la planificacion de trabajo.
Utilizacion de la totalidad de los casos de uso respecto al trabajo.
Correccion de errores relacionados con las iteraciones del trabajo.
